...
const AppLandingPage = () => {
  return (
    <div className={styles.appLandingPage}>
      ...
      <div className={styles.createdWithWrapper}>
        <CreatedWith />
      </div>
      <main className={styles.wrapperGroup35897Parent}>
        ...
        <img
          className={styles.booleanGateIcon}
          loading="lazy"
          alt=""
          src="/star-8.svg"
        />
        <div className={styles.eventDispatcher}>
          <div className={styles.wrapperOutputManager}>
            <img
              className={styles.outputManagerIcon}
              alt=""
        ...
        <img
          ...
          src="/star-5.svg"
        />
        <img className={styles.frameChild11} alt="" src="/star-2.svg" />
        <img
        ...
        />
        <img
          className={styles.testimonialBackgroundIcon}
          loading="lazy"
          alt=""
          src="/vector-1.svg"
        />
      ...
      <div className={styles.frameParent4}>
        <FrameComponent />
        <footer className={styles.frameFrame}>
